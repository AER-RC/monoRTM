       ...
       Subroutine TIPS_2003 (mol_max,temp_lbl,scor)
!*********************** 
...
!..
!.. Abstract: Total internal partition sums (TIPS) are calculated for all 
!.. molecular species in the 2000 HITRAN database.  In addition, the TIPS for 13 
!.. other isotopomers/isotopologues of ozone and carbon dioxide are presented.  
!.. The calculations address the corrections suggested by Goldman et al. 
!.. (JQSRT 2000;66:455-86).  The calculations consider the temperature range 
!.. 70-3000 K to be applicable to a variety of remote sensing needs.  The method 
!.. of calculation for each molecular species is stated and comparisons with data
!.. from the literature are discussed.  A new method of recall for the partition 
!.. sums, Lagrange 4-point interpolation, is developed.  This method, unlike 
!.. previous versions of the TIPS code, allows all molecular species to be 
!.. considered.  
...
!
!++
!     Max_ISO here is the number that TIPS treats: LBLRTM is limited to 9
!
...
!     *****************
      Subroutine QT_H2O   (        &               
       ...
       iso, &	! I isotope code (HITRAN INDEX)
       gsi, &	! O state independent nuclear degeneracyfactor
       QT) 	! O Total Internal Partition Function
