...
C                                                                        FA04820
     ...
     *                  IFXTYP,MUNITS,RE,HSPACE,XVBAR,CO2MX              FA04840
         !--------CHECK THE INPUTS TO MAKE SURE THEY
         !        ARE COMPATIBLE WITH MONORTM
         !        SID AHMED BOUKABARA AER INC 2001.
         IF (MUNITS.NE.0) THEN
            WRITE(*,*) '*******WARNING*******'
            WRITE(*,*) 'PLEASE SELECT MOLECULAR AMOUNT OPTION'
            WRITE(*,*) '(MUNITS=0) IN LBLRTM.IN IF YOU WANT '
            WRITE(*,*) 'TO BE COMPATIBLE WITH MONORTM'
            STOP
         ENDIF
         IF (MUNITS.EQ.1) THEN
            WRITE(*,*) '*******WARNING*******'
            WRITE(*,*) ' MONORTM HAS NOT BEEN VALIDATED YET'
            WRITE(*,*) ' FOR HORIZONTAL PATH CALCULATION'
         ENDIF
      ENDIF                                                              FA04850
C                                                                        FA04860
      NOP = NOPRNT                                                       FA04870
     ...
     *                IFXTYP,MUNITS,RE,HSPACE,XVBAR,CO2MX                FA04910
      ...
      IF (IPUNCH.EQ.1) OPEN (UNIT=IPU,FILE='in/TAPE7',STATUS='UNKNOWN')  FA05000
